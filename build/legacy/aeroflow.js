(function (global, factory) {
  ...
  var adapters = objectDefineProperties([iterableAdapter], (_objectDefineProperti = {}, _defineProperty(_objectDefineProperti, AEROFLOW, { value: flowAdapter }), _defineProperty(_objectDefineProperti, ARRAY, { configurable: true, value: arrayAdapter, writable: true }), _defineProperty(_objectDefineProperti, ERROR, { configurable: true, value: errorAdapter, writable: true }), _defineProperty(_objectDefineProperti, FUNCTION, { configurable: true, value: functionAdapter, writable: true }), _defineProperty(_objectDefineProperti, PROMISE, { configurable: true, value: promiseAdapter, writable: true }), _objectDefineProperti));
  ...
  */
  ...
  Flow[PROTOTYPE] = objectCreate(operators, (_objectCreate = {}, _defineProperty(_objectCreate, CLASS, { value: AEROFLOW }), _defineProperty(_objectCreate, 'bind', { value: bind }), _defineProperty(_objectCreate, 'chain', { value: chain }), _defineProperty(_objectCreate, 'concat', { value: concat }), _defineProperty(_objectCreate, 'run', { value: run }), _objectCreate));
