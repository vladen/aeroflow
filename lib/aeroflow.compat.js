...
(function (global, factory) {
  ...
  function makeLimiter(limiter) {
    return isNumber(limiter) ? function (value, index) {
  ...
  var Aeroflow = (function () {
    ...
    _createClass(Aeroflow, [{
      ...
      key: 'sort',
      value: function sort() {
        for (var _len2 = arguments.length, comparers = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
          comparers[_key2] = arguments[_key2];
        }

        return _sort.apply(undefined, [this].concat(comparers));
      }
    }, {
      key: 'sum',
      value: function sum() {
  ...
  function _concat() {
    for (var _len3 = arguments.length, flows = Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
      flows[_key3] = arguments[_key3];
    }
  ...
  function sortWithComparers(flow) {
    for (var _len5 = arguments.length, comparers = Array(_len5 > 1 ? _len5 - 1 : 0), _key5 = 1; _key5 < _len5; _key5++) {
      comparers[_key5 - 1] = arguments[_key5];
    }

    var array = flow.toArray(),
        comparer = comparers.reduce(function (previous, current) {
  ...
  function sortWithoutComparer(flow) {
    ...
    return new Aeroflow(function (next, done, context) {
      return array[EMITTER](function (values) {
        return values.length ? values.sort().forEach(next) : false;
      }, done, context);
    });
  }
