...
describe('aeroflow', () => {
  ...
  it('creates flow from scalar value', done => {
    let count = 0,
        value = 'test',
        onDone = () => {
  ...
  it('does not wrap flow twice', done => {
    let count = 0,
        value = 'test',
        onDone = () => {
      assert.strictEqual(count, 1);
  ...
  it('creates flow from array', done => {
    let count = 0,
        values = ['a', 'b'],
        onDone = () => {
  ...
  it('creates flow from function returning scalar value', done => {
    let count = 0,
        value = 'test',
        onDone = () => {
      assert.strictEqual(count, 1);
  ...
  it('creates flow from function returning array', done => {
    let count = 0,
        values = ['a', 'b'],
        onDone = () => {
      assert.strictEqual(count, values.length);
  ...
  it('creates flow from promise', done => {
    let count = 0,
        value = 'test',
        onDone = () => {
      assert.strictEqual(count, 1);
  ...
  it('creates flow from function returning promise resolving to scalar value immediately', done => {
    let count = 0,
        value = 'test',
        onDone = () => {
      assert.strictEqual(count, 1);
  ...
  it('creates flow from function returning promise resolving to array immediately', done => {
    let count = 0,
        values = ['a', 'b'],
        generator = () => Promise.resolve(values),
        onDone = () => {
      assert.strictEqual(count, values.length);
      done();
    },
  ...
  it('creates flow from function returning promise resolving to scalar value eventually', done => {
    let count = 0,
        value = 'test',
        generator = () => new Promise(resolve => setTimeout(() => resolve(value), 10)),
        onDone = () => {
      assert.strictEqual(count, 1);
      done();
    },
  ...
  it('creates flow from function returning promise resolving to array eventually', done => {
    let count = 0,
        values = ['a', 'b'],
        generator = () => new Promise(resolve => setTimeout(() => resolve(values), 10)),
        onDone = () => {
      assert.strictEqual(count, values.length);
      done();
    },
  ...
  describe('concat', () => {
    it('is instance method', () => assert.isFunction(aeroflow.empty.concat));
    it('concatenates several values into one flow', done => {
      let count = 0,
          values = [1, 2, 3],
          onDone = () => {
        assert.strictEqual(count, values.length);
    ...
    it('concatenates several arrays into one flow', done => {
      let count = 0,
          times = 3,
          values = [1, 2],
          onDone = () => {
  ...
  describe('count', () => {
    ...
    it('returns valid result for non-empty flow', done => {
      let count,
          values = Array(3),
          onDone = () => {
        assert.strictEqual(count, values.length);
  ...
  describe('empty', () => {
    it('is static property', () => assert.typeOf(aeroflow.empty, 'Aeroflow'));
    it('returns empty flow', done => {
      let count = 0,
          onDone = () => {
        assert.strictEqual(count, 0);
        done();
  ...
  describe('expand', () => {
    ...
    it('creates flow geometrically progressing integers', done => {
      let count = 0,
  ...
  describe('first', () => {
    it('is instance method', () => assert.isFunction(aeroflow.empty.first));
    it('emits first value only', done => {
      let values = [1, 2, 3],
          results = [],
          onDone = () => {
  ...
  describe('just', () => {
    ...
    it('creates flow of single array value', done => {
      let count = 0,
          value = [2, 4, 8],
          onDone = () => {
        assert.strictEqual(count, 1);
    ...
    it('creates flow of single function value', done => {
      let count = 0,
          value = () => {},
          onDone = () => {
        assert.strictEqual(count, 1);
    ...
    it('creates flow of single promise value', done => {
      let count = 0,
  ...
  describe('last', () => {
    it('is instance method', () => assert.isFunction(aeroflow.empty.last));
    it('emits last value only', done => {
      let values = [1, 2, 3],
          results = [],
          onDone = () => {
        assert.strictEqual(results.length, 1);
  ...
  describe('max', () => {
    ...
    it('returns no results for empty flow', done => {
      let empty = true,
          onDone = () => {
        assert.isTrue(empty);
        done();
  ...
  describe('repeat', () => {
    ...
    it('creates flow emitting specified limit of undefined values', done => aeroflow.repeat().take(3).run(next => assert.isUndefined(next), done));
  ...
  describe('share', () => {
    it('is instance method', () => assert.isFunction(aeroflow.empty.share));
    it('invokes emitter only once than shares results to subsequent run', done => {
      let invocations = 0,
          emitter = () => invocations++,
          onDone = () => {
    ...
    it('invokes emitter only once than shares results to subsequent run until expires', done => {
      let expiration = 50,
          invocations = 0,
          emitter = () => invocations++,
  ...
  describe('skip', () => {
    ...
    it('skips all values and emits "done" signal only', done => {
      let values = [1, 2, 3, 4],
          empty = true,
          onDone = () => {
        assert.isTrue(empty);
    ...
    it('skips specified number of values emits remaining values', done => {
      let values = [1, 2, 3, 4],
          results = [],
          skip = 2,
          onDone = () => {
    ...
    it('skips while specified function returns true emits remaining values', done => {
      let values = [1, 2, 3, 4],
          results = [],
          skip = 2,
  ...
  describe('sort', () => {
    it('is instance method', () => assert.isFunction(aeroflow.empty.sort));
    it('emits values sorted in ascending order when no parameters specified', done => {
      let values = [2, 1, 4, 3],
          sorted = [...values].sort(),
          count = 0,
          onDone = () => {
    ...
    it('emits values sorted in descending order when order parameter has value "desc"', done => {
      let values = [2, 1, 4, 3],
    ...
    it('emits objects sorted in ascending order by multiple keys when key selectors specified', done => {
      let values = [{ id: 2, name: 'a' }, { id: 2, name: 'b' }, { id: 1, name: 'b' }, { id: 1, name: 'a' }],
          sorted = [...values].sort((left, right) => left.id < right.id ? -1 : left.id > right.id ? 1 : left.name < right.name ? -1 : left.name > right.name ? 1 : 0),
          count = 0,
          onDone = () => {
        assert.strictEqual(count, values.length);
        done();
    ...
    it('emits objects sorted in descending order by multiple keys when key selectors specified', done => {
      let values = [{ id: 2, name: 'a' }, { id: 2, name: 'b' }, { id: 1, name: 'b' }, { id: 1, name: 'a' }],
          sorted = [...values].sort((left, right) => left.id < right.id ? 1 : left.id > right.id ? -1 : left.name < right.name ? 1 : left.name > right.name ? -1 : 0),
          count = 0,
          onDone = () => {
  ...
  describe('take', () => {
    it('is instance method', () => assert.isFunction(aeroflow.empty.take));
    it('emits all values if no parameters specified', done => {
      let values = [1, 2, 3, 4],
          results = [],
          onDone = () => {
    ...
    it('emits specified number of first values', done => {
      let values = [1, 2, 3, 4],
          results = [],
          take = 2,
          onDone = () => {
    ...
    it('emits first values while specified function returns true', done => {
      let values = [1, 2, 3, 4],
          results = [],
          take = 2,
  ...
  describe('tap', () => {
    it('is instance method', () => assert.isFunction(aeroflow.empty.tap));
  ...
  describe('toMap', () => {
    it('is instance method', () => assert.isFunction(aeroflow.empty.toMap));
    it('emits single map object containing flow values as both keys and values if no parameters specified', done => {
      let values = [1, 2, 3],
          results = [],
          onDone = () => {
        assert.strictEqual(results.length, 1);
  ...
  describe('unique', () => {
    it('is instance method', () => assert.isFunction(aeroflow.empty.unique));
    it('emits unique values only', done => {
      let unique = [1, 2, 3],
