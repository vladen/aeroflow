...
describe('aeroflow', () => {
  ...
  describe('concat', () => {
    it('is static method', () => assert.isFunction(aeroflow.concat));
  ...
  describe('skip', () => {
    ...
    it('emits "done" signal only skipping all values if no parameter specified', done => {
      let values = [1, 2, 3, 4],
          empty = true,
          onDone = () => {
        assert.isTrue(empty);
    ...
    it('emits remaining values skipping specified number of values', done => {
      let values = [1, 2, 3, 4],
          results = [],
          skip = 2,
          onDone = () => {
    ...
    it('emits remaining values skipping while specified function returns true', done => {
      let values = [1, 2, 3, 4],
          results = [],
          skip = 2,
