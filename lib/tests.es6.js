...
describe('aeroflow', () => {
  ...
  describe('append', () => {
    ...
    it('append several values to the flow', done => {
      let count = 0,
          values = [1, 2, 3],
          onDone = () => {
        assert.strictEqual(count, values.length);
    ...
    it('append several arrays to the flow', done => {
      let count = 0,
          times = 3,
          values = [1, 2],
          onDone = () => {
  ...
  describe('repeat', () => {
    ...
    it('creates flow emitting undefined values', done => aeroflow.repeat().take(1).run(next => assert.isUndefined(next), done));
