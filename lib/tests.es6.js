...
describe('aeroflow', () => {
  ...
  it('returns existing flow as is, withouth wrapping it', done => {
    let expected = 'test';
    aeroflow(aeroflow(expected)).run(value => {
      assert.strictEqual(value, expected);
      expected = null;
    }, () => {
      assert.isNull(expected);
  ...
  it('creates flow emitting array items', done => {
    let expected = ['a', 'b'];
    aeroflow(expected).run(value => assert.strictEqual(value, expected.shift()), () => {
  ...
  it('creates flow emitting map entries', done => {
    ...
    aeroflow(new Map(expected)).run(value => assert.includeMembers(value, expected.shift()), () => {
      assert.strictEqual(expected.length, 0);
      done();
    });
  });
  ...
  it('creates flow emitting set keys', done => {
    let expected = ['a', 'b'];
    aeroflow(new Set(expected)).run(value => assert.strictEqual(value, expected.shift()), () => {
      assert.strictEqual(expected.length, 0);
      done();
    });
  });
  ...
  it('creates flow emitting scalar value resolved by promise', done => {
    let expected = 'test';
    aeroflow(Promise.resolve(expected)).run(value => {
      assert.strictEqual(value, expected);
      expected = null;
    }, () => {
      assert.isNull(expected);
  ...
  it('creates flow emitting items of array resolved by promise', done => {
    let expected = ['a', 'b'];
    aeroflow(Promise.resolve(expected)).run(value => assert.strictEqual(value, expected.shift()), () => {
      assert.strictEqual(expected.length, 0);
      done();
    });
  });
  ...
  it('creates flow emitting scalar value resolved by promise asynchronously', done => {
    let expected = 'test';
    aeroflow(new Promise(resolve => setTimeout(() => resolve(expected)))).run(value => {
      assert.strictEqual(value, expected);
      expected = null;
    }, () => {
      assert.isNull(expected);
  ...
  it('creates flow emitting items of array resolved by promise asynchronously', done => {
    let expected = ['a', 'b'];
    aeroflow(new Promise(resolve => setTimeout(() => resolve(expected)))).run(value => assert.strictEqual(value, expected.shift()), () => {
      assert.strictEqual(expected.length, 0);
      done();
    });
  });
