...
<dd><p>Creates new flow emitting values extracted from every provided data source in series.
If no data sources provided, creates empty flow emitting &quot;done&quot; event only.</p>
</dd>
</dl>
